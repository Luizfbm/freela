...
function buildGuardianRepairPayload(blocked, rules, closerAgentId) {
  ...
  return {
    ...
    description: [
      ...
      "- Depois da nova Outbox, devolver ao fluxo seguro com `node scripts/freela-crm.mjs whatsapp guardian review --outbox-id [id] --auto-wake true --auto-dispatch true`.",
      "- Nao envie WhatsApp diretamente. Nao chame bridge nem endpoint cru.",
